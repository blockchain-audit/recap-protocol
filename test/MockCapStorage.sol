...
import { CapStorage, Market, State } from "../src/contracts/CapStorage.sol";
...
contract MockCapStorage is CapStorage {
    ...
    constructor() {
        ...
        // You should continue initializing other state variables as needed...

        // For MarketData, PositionData, UserBalances, and FundingData, initialize based on your contract's logic.
        // Example:
    ...
    function getUesrBalance(address user) public returns (uint256) {
    ...
    function setTradeAddress(address trade) public {
        state.contractAddresses.trade = trade;
    }
}
