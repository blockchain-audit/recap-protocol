...
import {stateTrade} from "src/trade/tradeStorage.sol";

contract Trade is ITrade {

    stateTrade state_trade;
    ...
    // Modifiers
    modifier onlyGov() {
        require(msg.sender == state_trade.gov, "!governance");
        _;
    }

    constructor(address _gov) {
        state_trade.gov = _gov;
    }
    ...
    function updateGov(address _gov) external onlyGov {
        ...
        address oldGov = state_trade.gov;
        state_trade.gov = _gov;
